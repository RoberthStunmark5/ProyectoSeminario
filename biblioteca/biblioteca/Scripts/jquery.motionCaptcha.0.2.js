...
jQuery.fn.motionCaptcha || (function($) {
	...
	$.fn.motionCaptcha.defaults = {
		...
		errorMsg: 'Intente de Nuevo.',
		successMsg: 'Captcha Aprobado!',
		
		// This message is displayed if the user's browser doesn't support canvas:
		noCanvasMsg: "Tu navegador no soporta <canvas> - intenta con Chrome, FF4, Safari or IE9.",
		
		// This could be any HTML string (eg. '<label>Draw this shit yo:</label>'):
		label: '<p>Por favor dibuja la forma en el cuadro:</p>',
